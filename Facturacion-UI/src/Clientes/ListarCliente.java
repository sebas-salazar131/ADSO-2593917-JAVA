...
public class ListarCliente extends javax.swing.JFrame {
    ...
    Inicio menu;
    public ListarCliente(Inicio menu) {
        this.menu=menu;
        initComponents();
    ...
    public void mostrar_usuario(){
        ...
        for(int i=0; i<this.menu.listaClientes.length; i++){
            ...
            if(this.menu.listaClientes[i]!=null){
                ...
                String nombre=this.menu.listaClientes[i].getNombres();
                String apellido=this.menu.listaClientes[i].getApellidos();
                String direccion=this.menu.listaClientes[i].getDireccion();
                String telefono=this.menu.listaClientes[i].getTelefonos();
                String email=this.menu.listaClientes[i].getEmail();
