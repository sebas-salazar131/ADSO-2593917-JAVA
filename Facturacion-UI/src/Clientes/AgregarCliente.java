...
public class AgregarCliente extends javax.swing.JFrame {
    ...
    Inicio menu;
    public AgregarCliente(Inicio menu) {
        this.menu=menu;
        initComponents();
    ...
    private void initComponents() {
        ...
        input_cedula.setBackground(new java.awt.Color(0, 0, 0));
        ...
        input_apellidos.setBackground(new java.awt.Color(0, 0, 0));
        input_apellidos.setForeground(new java.awt.Color(255, 255, 255));
        ...
        input_direccion.setBackground(new java.awt.Color(0, 0, 0));
        ...
        input_telefono.setBackground(new java.awt.Color(0, 0, 0));
        input_telefono.setForeground(new java.awt.Color(255, 255, 255));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(input_email, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        Cliente personas= new Cliente(cedula, nombres, apellidos, direccion, telefono, email);
        ...
        for(int i=0; i<this.menu.listaClientes.length; i++){
            if(!cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !direccion.equals("") && !telefono.equals("") && !email.equals("")){
                if(this.menu.listaClientes[i]==null){
                    this.menu.listaClientes[i]=personas;
                    dispose();
