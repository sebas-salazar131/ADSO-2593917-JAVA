...
public class ModificarCliente extends javax.swing.JFrame {
    Inicio menu;
    int pos;
    public ModificarCliente(Inicio menu) {
        this.pos=0;
        this.menu=menu;
        initComponents();
    ...
    private void initComponents() {
        ...
        panel_encontrar.setBackground(new java.awt.Color(255, 153, 255));

        mostrar_resultado.setBackground(new java.awt.Color(0, 0, 0));
        mostrar_resultado.setColumns(20);
        mostrar_resultado.setFont(new java.awt.Font("Segoe UI Black", 0, 14)); // NOI18N
        mostrar_resultado.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private boolean Buscar(){
        for(int i=0; i<this.menu.listaClientes.length; i++){         
            if(this.menu.listaClientes[i]!=null){        
             String cedula = this.menu.listaClientes[i].getCedula();
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if(cedulaa.equals("") && nombre.equals("") && apellido.equals("") && direccion.equals("") && telefono.equals("") && email.equals("")){
            Alert alerta= new Alert("Datos invalidos", "Todos los campos deben ser llenado", "Error" );
        }else{
            this.menu.listaClientes[this.pos].setCedula(cedulaa);
            this.menu.listaClientes[this.pos].setNombres(nombre);
            this.menu.listaClientes[this.pos].setApellidos(apellido);
            this.menu.listaClientes[this.pos].setTelefonos(telefono);
            this.menu.listaClientes[this.pos].setDireccion(direccion);
            this.menu.listaClientes[this.pos].setEmail(email);
