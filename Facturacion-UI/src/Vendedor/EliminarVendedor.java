...
public class EliminarVendedor extends javax.swing.JFrame {
    ...
    Inicio vent_menu;
    public EliminarVendedor(Inicio vent_menu) {
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        for(int i=0; i<this.vent_menu.listaVendedores.length; i++){
            if(this.vent_menu.listaVendedores[i]!=null){
                String cedula = this.vent_menu.listaVendedores[i].getCedula();
                String cedula_eliminar=input_cedula_eliminar.getText();
                if( cedula_eliminar.equals(cedula)){
                    pos=i;
                    for(int j=pos; j<this.vent_menu.listaVendedores.length-1; j++){
                        this.vent_menu.listaVendedores[j]=this.vent_menu.listaVendedores[j+1];
                        mostrar_eliminar.setText("Vendedor Eliminado");
                    }
                }
            }
            ...
            if(this.vent_menu.listaVendedores[i]!=null){        
             ...
             String cedula_modificar=input_cedula_eliminar.getText();
                if( cedula_modificar.equals(cedula)){
                    ...
                    String cedulaa=this.vent_menu.listaVendedores[i].getCedula();
                    String nombre=this.vent_menu.listaVendedores[i].getNombres();
                    String apellido=this.vent_menu.listaVendedores[i].getApellidos();
