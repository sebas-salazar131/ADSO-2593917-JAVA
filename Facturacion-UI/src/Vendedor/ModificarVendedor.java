...
public class ModificarVendedor extends javax.swing.JFrame {
    ...
    Inicio menu;
    public ModificarVendedor(Inicio menu) {
        this.menu=menu;
        initComponents();
    ...
    private void btn_modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_modificarActionPerformed
        ...
        if(cedulaa.equals("") && nombre.equals("") && apellido.equals("") && direccion.equals("") && telefono.equals("") && email.equals("")){
            ...
            this.menu.listaVendedores[this.pos].setCedula(cedulaa);
            this.menu.listaVendedores[this.pos].setNombres(nombre);
            this.menu.listaVendedores[this.pos].setApellidos(apellido);
            this.menu.listaVendedores[this.pos].setTelefonos(telefono);
            this.menu.listaVendedores[this.pos].setDireccion(direccion);
            this.menu.listaVendedores[this.pos].setEmail(email);
