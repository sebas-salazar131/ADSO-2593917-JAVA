...
public class AgregarVendedor extends javax.swing.JFrame {
    ...
    Inicio menu;
    public AgregarVendedor(Inicio menu) {
        this.menu=menu;
        initComponents();
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        Vendedor vendedor= new Vendedor(cedula, nombres, apellidos, direccion, telefono, email);
        ...
        for(int i=0; i<this.menu.listaVendedores.length; i++){
            if(!cedula.equals("") && !nombres.equals("") && !apellidos.equals("") && !direccion.equals("") && !telefono.equals("") && !email.equals("")){
                if(this.menu.listaVendedores[i]==null){
                    this.menu.listaVendedores[i]=vendedor;
                    dispose();
