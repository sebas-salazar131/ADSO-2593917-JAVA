...
public class MostrarProductos extends javax.swing.JFrame {
    ...
    Inicio menu;
    public MostrarProductos(Inicio menu) {
        this.menu=menu;
        initComponents();
    ...
    private void initComponents() {
        ...
        etq_titu.setText("LISTA PRODUCTOS");
    ...
    public void mostrar_producto(){
        ...
        for(int i=0; i<this.menu.listaProducto.length; i++){
            ...
            if(this.menu.listaProducto[i]!=null){
                String id=this.menu.listaProducto[i].getId();
                String nombre=this.menu.listaProducto[i].getNombres();
                int precio=this.menu.listaProducto[i].getPrecio();
                int cantidad=this.menu.listaProducto[i].getCantidad();
                
                String texto="#"+i+"        "+id+"  -  "+nombre+"  -  "+precio+"  -  "+cantidad+"\n";
