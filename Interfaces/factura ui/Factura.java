...
public class Factura extends JFrame{
	...
	// Metodos
	public Factura(Persona[] listaClientes, Persona[] listaVendedores){
	...
	public void initComponent(){
		...
		label_nombres_vendedor=new JLabel("NOMBRES:");
		restriccion.gridy = 6;
		restriccion.gridx = 0;
		restriccion.gridheight = 1;
		restriccion.gridwidth = 1;
		...
		label_productos = new JLabel("PRODUCTOS:");
